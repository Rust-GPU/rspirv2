...
Provides the SPIR-V grammar to Rust, using `spirv-grammar-parser` to parse it. You'll find prepared paths to the SPIR-V grammar JSON files in `lib.rs`. Part of [rspirv2](https://crates.io/crates/rspirv2).
