...
impl InstEncoding for GlslInstSet {
    ...
    fn id_result(&self) -> Self::IdResult {
        ...
        match self {
            Self::Round(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::RoundEven(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Trunc(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FAbs(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::SAbs(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FSign(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::SSign(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Floor(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Ceil(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Fract(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Radians(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Degrees(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Sin(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Cos(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Tan(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Asin(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Acos(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Atan(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Sinh(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Cosh(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Tanh(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Asinh(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Acosh(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Atanh(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Atan2(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Pow(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Exp(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Log(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Exp2(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Log2(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Sqrt(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::InverseSqrt(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Determinant(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::MatrixInverse(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Modf(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::ModfStruct(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FMin(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::UMin(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::SMin(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FMax(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::UMax(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::SMax(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FClamp(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::UClamp(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::SClamp(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FMix(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::IMix(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Step(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::SmoothStep(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Fma(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Frexp(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FrexpStruct(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Ldexp(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::PackSnorm4x8(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::PackUnorm4x8(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::PackSnorm2x16(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::PackUnorm2x16(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::PackHalf2x16(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::PackDouble2x32(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::UnpackSnorm2x16(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::UnpackUnorm2x16(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::UnpackHalf2x16(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::UnpackSnorm4x8(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::UnpackUnorm4x8(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::UnpackDouble2x32(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Length(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Distance(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Cross(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Normalize(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FaceForward(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Reflect(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::Refract(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FindILsb(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FindSMsb(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::FindUMsb(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::InterpolateAtCentroid(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::InterpolateAtSample(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::InterpolateAtOffset(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::NMin(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::NMax(inst) => InstEncoding::id_result(inst).to_optional(),
            Self::NClamp(inst) => InstEncoding::id_result(inst).to_optional(),
        }
    }
    fn id_result_type(&self) -> Self::IdResult {
        profiling::function_scope!();
        match self {
            Self::Round(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::RoundEven(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Trunc(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FAbs(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::SAbs(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FSign(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::SSign(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Floor(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Ceil(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Fract(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Radians(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Degrees(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Sin(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Cos(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Tan(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Asin(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Acos(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Atan(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Sinh(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Cosh(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Tanh(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Asinh(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Acosh(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Atanh(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Atan2(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Pow(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Exp(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Log(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Exp2(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Log2(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Sqrt(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::InverseSqrt(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Determinant(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::MatrixInverse(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Modf(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::ModfStruct(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FMin(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::UMin(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::SMin(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FMax(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::UMax(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::SMax(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FClamp(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::UClamp(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::SClamp(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FMix(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::IMix(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Step(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::SmoothStep(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Fma(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Frexp(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FrexpStruct(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Ldexp(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::PackSnorm4x8(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::PackUnorm4x8(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::PackSnorm2x16(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::PackUnorm2x16(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::PackHalf2x16(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::PackDouble2x32(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::UnpackSnorm2x16(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::UnpackUnorm2x16(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::UnpackHalf2x16(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::UnpackSnorm4x8(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::UnpackUnorm4x8(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::UnpackDouble2x32(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Length(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Distance(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Cross(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Normalize(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FaceForward(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Reflect(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::Refract(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FindILsb(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FindSMsb(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::FindUMsb(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::InterpolateAtCentroid(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::InterpolateAtSample(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::InterpolateAtOffset(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::NMin(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::NMax(inst) => InstEncoding::id_result_type(inst).to_optional(),
            Self::NClamp(inst) => InstEncoding::id_result_type(inst).to_optional(),
        }
    }
    fn name() -> &'static str {
